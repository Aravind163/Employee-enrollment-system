    ...
    <Layout>
      <div className="form-page">
        <div className="form-page-header" onClick={() => navigate('/employee')}>
          <MdArrowBack /><span>Add New Employee</span>
        </div>
        ...
        <div className="form-grid">
          ...
          <div className="form-group">
            ...
            <div className="form-select-wrapper">
              <select className="form-select" name="department" value={form.department} onChange={handleChange} style={errors.department?{borderColor:'#ef4444'}:{}}>
          ...
          <div className="form-group">
            ...
            <div className="form-select-wrapper">
              <select className="form-select" name="designation" value={form.designation} onChange={handleChange} style={errors.designation?{borderColor:'#ef4444'}:{}}>
          ...
          <div className="form-group">
            ...
            <div className="form-select-wrapper">
              <select className="form-select" name="type" value={form.type} onChange={handleChange} style={errors.type?{borderColor:'#ef4444'}:{}}>
          ...
          <div className="form-group">
            ...
            <div className="form-select-wrapper">
              <select className="form-select" name="status" value={form.status} onChange={handleChange} style={errors.status?{borderColor:'#ef4444'}:{}}>
